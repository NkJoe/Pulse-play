...
function loadDemoMovies() {
    ...
    const demoMovies = {
        ...
        'drama': [
            { id: 13, title: 'The Whale', poster: './whale.jpeg', rating: 7.7, year: 2022, genre: 'Drama, History', videoUrl: 'https://www.w3schools.com/html/whale.mp4', downloadUrl: 'https://downloadwella.com/jsd3ha1ywuip/The.Whale.(NKIRI.COM).2022.WEBRip.DOWNLOADED.FROM.NKIRI.COM.mkv.html' },
            { id: 14, title: 'Everything Everywhere All at Once', poster: 'eeaat.jpeg', rating: 8.0, year: 2022, genre: 'Drama, Sci-Fi', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', downloadUrl: 'https://downloadwella.com/jsd3ha1ywuip/The.Whale.(NKIRI.COM).2022.WEBRip.DOWNLOADED.FROM.NKIRI.COM.mkv.html' },
            { id: 15, title: 'The Banshees of Inisherin', poster: './banshee.jpeg', rating: 7.8, year: 2022, genre: 'Drama, Comedy', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', downloadUrl: 'https://downloadwella.com/27u50ttipp9a/The.Banshees.of.Inisherin.(NKIRI.COM).2022.AMZN.WEBRip.DOWNLOADED.FROM.NKIRI.COM.mkv.html' },
            { id: 16, title: 'Tár', poster: 'https://via.placeholder.com/200x300/1a2a2a/ffffff?text=Tar', rating: 7.4, year: 2022, genre: 'Drama, Music', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', downloadUrl: '#' },
            { id: 17, title: 'Triangle of Sadness', poster: './tos.jpeg', rating: 7.2, year: 2022, genre: 'Drama, Comedy', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', downloadUrl: 'https://downloadwella.com/ukqvvzegftld/Triangle.of.Sadness.(NKIRI.COM).2022.WEBRip.DOWNLOADED.FROM.NKIRI.COM.mkv.html' },
            { id: 18, title: 'Women Talking', poster: './women.jpeg', rating: 7.3, year: 2022, genre: 'Drama, Thriller', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', downloadUrl: '#' }
        ],
        'comedy': [
